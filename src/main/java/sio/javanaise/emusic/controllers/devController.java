...
public class devController {
	...
	private @ResponseBody String ajoutData(@PathVariable int nb) {
		...
		for (int o = 0; o < nb; o++) {
			...
			planning.setDateDebut(localdate.parse("2018-11-01"));

			planning.setHeureFin(localtime.of(12, 0));
			planning.setHeureDebut(localtime.of(11, 0));
